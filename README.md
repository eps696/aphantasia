...
* continuous mode to process phrase lists (e.g. illustrating lyrics)
	...
	* depth-based 3D look (in [Colab](https://colab.research.google.com/github/eps696/aphantasia/blob/master/IllusTrip3D.ipynb) version, courtesy of [deKxi])
* complex queries:
...
New method, interpolating topics as a constant flow with permanent pan/zoom motion. Colab version also includes 3D depth processing.  
